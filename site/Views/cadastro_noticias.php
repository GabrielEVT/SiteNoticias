<main class="pagina-cadastro" id="noticia">
    <form action="process.php" method="post" enctype="multipart/form-data" class="formulario">
        ...
        <input type="text" name="titulo" placeholder="Título" id="campo-titulo-noticia" required>
        ...
        <textarea class="text-area" name="corpo" cols="30" rows="10" placeholder="Corpo da notícia" id="campo-corpo-noticia" required></textarea>
